...
## Summary
During the off-boarding of a former strategist in May 2025, several issues were discovered affecting strategies which the strategist was responsible for:
- The strategist deployed several versions of APR Oracles between Nov 2024 and April 2025 meant to inflate the reported APR on the USDS Sky Compounder. This mainly impacted projected APYs reported in the UI, and to a lesser extent debt allocations on the yvUSDS-1 vault. A corrected version [[1]](#References) of this APR oracle was deployed and set on the central APR oracle.
